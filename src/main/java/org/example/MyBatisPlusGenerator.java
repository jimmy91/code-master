...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        config.setActiveRecord(true)
                ...
                // 生成路径，最好使用绝对路径
                //TODO  TODO  TODO  TODO
                .setOutputDir("E:\\jimmy\\tools_project\\src\\main\\java\\generator")
                // 文件覆盖
        ...
        stConfig.setCapitalMode(true)
                ...
                //你自己的父类实体
                .setSuperEntityClass("cn.inno.pala.framework.mybatis.core.dataobject.BaseDO")
                //使用restcontroller注解
        ...
        pkConfig.setParent("cn.inno.pala.module")
                .setMapper("mapper")
                .setService("service")
