...
public final class PackageInfoConstant {
     ...
     * 包路径(基础包路径)
     */
    public static String PACKAGE_ROOT = "generatorTemplate.common.src.main.java.com.study" ;
    /**
     ...
     * 根路径
     */
    public static String ROOT_PROJECT_PATH = "/src/main/java/generatorTemplate/common" ;
    /**
     * 输出基础包
     */
