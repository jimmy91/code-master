...
public class MyBatisPlusTemplateGenerator {
    ...
    private static void builder(boolean isCreateExt) {
        ...
        config.setActiveRecord(true)
                ...
                .setSwagger2(true)
                // 作者
                .setAuthor(BasicConstant.author)
                // 设置实体类名称
                .setEntityName("%sDO")
                //设置服务类名称
        ...
        stConfig.setCapitalMode(true)
                ...
                // 去除表前缀
                .setTablePrefix(BasicConstant.ENTITY_IGNORE_PREFIX)
...
//                .setVersionFieldName("version")
                ...
                .setSuperEntityColumns(
                        BasicConstant.SUPER_ENTITY_COLUMNS
                );
        //配置父类
        if (Objects.nonNull(BasicConstant.SUPER_ENTITY_CLASS) && BasicConstant.SUPER_ENTITY_CLASS.length() > 0) {
            stConfig.setSuperEntityClass(BasicConstant.SUPER_ENTITY_CLASS);
        }
