...
/**
 * 滑动窗口限流工具类
 * https://blog.csdn.net/yangbindxj/article/details/124396314
...
public class RateLimiterSlidingWindow {
     ...
     * 多少个子窗口
     */
    private static Integer windowCount = 10;
    /**
     * 窗口列表
     */
    private static WindowInfo[] windowArray = new WindowInfo[windowCount];

    public RateLimiterSlidingWindow() {
    ...
    public static void test1() throws InterruptedException {
        ...
        success = 0;
        RateLimiterSlidingWindow myRateLimiter = new RateLimiterSlidingWindow();
