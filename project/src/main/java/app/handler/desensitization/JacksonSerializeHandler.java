package app.handler.desensitization;
...
@AllArgsConstructor
@NoArgsConstructor
public class JacksonSerializeHandler extends JsonSerializer<String> implements ContextualSerializer {
    /**
     * 脱敏数据类型
     */
        ...
        if (beanProperty != null) {
            ...
            if (Objects.equals(beanProperty.getType().getRawClass(), String.class)) {
                ...
                if (desensitization != null) {
                    ...
                    return new JacksonSerializeHandler(desensitization.type(), desensitization.startInclude(),
